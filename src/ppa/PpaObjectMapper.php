...
class PpaObjectMapper {
    ...
    public static function createObject(string $class, array $data): object {
     ...
     * @throws
     */
    public static function mapObject(PpaEntity $obj, array $data, Entity $entity): object {
    ...
    public static function generateInsertSql(PpaEntity $obj, Entity $entity): array {
        $sql = 'insert' . ' into ';
        ...
        return [$sql, $bindVars, $outBindVars];
    }

    public static function generateUpdateSql(PpaEntity $obj, Entity $entity): array {
        $sql = 'update ';
        $bindVars = new BindVars();
    ...
    public static function generateDeleteSql(PpaEntity $obj, Entity $entity): array {
        $sql = 'delete';
        $bindVars = new BindVars();
